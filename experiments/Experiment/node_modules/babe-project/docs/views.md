...
* babeViews.postTest:
    ...
    * `ethnicity_question: string`
        * question about participant's ethnicity
        * default: 'Ethnicity'
    * `ethnicity_white: string`
        * answer option for ethnicity question
        * default: 'White'
    * `ethnicity_africanAmerican: string`
        * answer option for ethnicity question
        * default: 'African American'
    * `ethnicity_asian: string`
        * answer option for ethnicity question
        * default: 'Asian'
    * `ethnicity_Mixed: string`
        * answer option for ethnicity question
        * default: 'Mixed'
