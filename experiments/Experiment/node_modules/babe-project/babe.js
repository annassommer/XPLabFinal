...
const answer_container_generators = {
    ...
    post_test: function(config, CT) {
        ...
        return `<form>
                    ...
                    <p class='babe-view-text'>
                        <label for="ethnicity">${quest.ethnicity.title}:</label>
                        <select id="ethnicity" name="ethnicity">
                            <option></option>
                            <option value="${quest.ethnicity.white}">${quest.ethnicity.white}</option>
                            <option value="${quest.ethnicity.africanAmerican}">${quest.ethnicity.africanAmerican}</option>
                            <option value="${quest.ethnicity.asian}">${quest.ethnicity.asian}</option>
                            <option value="${quest.ethnicity.mixed}">${quest.ethnicity.mixed}</option>
                            <option value="${quest.ethnicity.other}">${quest.ethnicity.other}</option>
                        </select>
                    </p>
                    <p class='babe-view-text'>
...
const handle_response_functions = {
    ...
    post_test: function(config, CT, babe, answer_container_generator, startingTime) {
        ...
        $("#next").on("click", function(e) {
            ...
            babe.global_data.ethnicity = $("#ethnicity").val();
    ...
    view: {
        ...
        fill_defaults_post_test: function(config) {
            return {
                ...
                ethnicity: {
                    title: babeUtils.view.setter.prop(config.ethnicity_question, "With which ethnicity do you identify"),
                    white: babeUtils.view.setter.prop(config.ethnicity_white,"White"),
                    africanAmerican: babeUtils.view.setter.prop(config.ethnicity_africanAmerican,"African American"),
                    asian: babeUtils.view.setter.prop(config.ethnicity_asian,"Asian"),
                    mixed: babeUtils.view.setter.prop(config.ethnicity_mixed,"Mixed"),
                    other: babeUtils.view.setter.prop(config.ethnicity_other,"Other"),
                },
                langs: {
